...
class PdfApplication : MultiDexApplication(), LifecycleObserver, Application.ActivityLifecycleCallbacks {
            ...
            AppOpenAd.load(
                ...
                object : AppOpenAd.AppOpenAdLoadCallback() {
                    ...
                    override fun onAdLoaded(ad: AppOpenAd) {
                        ...
                        isLoadingAd = false
                        loadTime = Date().time
                        Logger.showLog("Thuytv---openResume----onAdLoaded")
                    }
