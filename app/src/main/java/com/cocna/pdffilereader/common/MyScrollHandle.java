...
public class MyScrollHandle extends RelativeLayout implements ScrollHandle {

    private final static int HANDLE_LONG = 20;
...
//        if (pdfView.isSwipeVertical()) {
            ...
            if (inverted) { // left
                ...
                background = ContextCompat.getDrawable(context, R.drawable.bg_scroll_view);
            } else { // right
