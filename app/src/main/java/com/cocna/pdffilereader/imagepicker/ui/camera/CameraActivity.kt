...
import com.cocna.pdffilereader.databinding.ImagepickerActivityCameraBinding
import com.cocna.pdffilereader.imagepicker.helper.Constants
import com.cocna.pdffilereader.imagepicker.helper.DeviceHelper
import com.cocna.pdffilereader.imagepicker.helper.PermissionHelper
import com.cocna.pdffilereader.imagepicker.helper.PermissionHelper.hasGranted
import com.cocna.pdffilereader.imagepicker.helper.PermissionHelper.openAppSettings
...
class CameraActivity : AppCompatActivity() {
    ...
    private fun showOpenSettingDialog() {
        val builder = AlertDialog.Builder(
            ContextThemeWrapper(
                this@CameraActivity,
                R.style.Theme_PdfReader_NoActionBar
            )
        )
        with(builder) {
