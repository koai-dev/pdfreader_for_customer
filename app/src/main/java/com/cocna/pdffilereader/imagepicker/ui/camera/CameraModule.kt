...
import com.cocna.pdffilereader.imagepicker.helper.ExifUtil
import com.cocna.pdffilereader.imagepicker.model.Image
import com.cocna.pdffilereader.imagepicker.model.ImagePickerConfig
import com.cocna.pdffilereader.imagepicker.model.RootDirectory
import java.io.File
                ...
                contentResolver.run {
                    ...
                    if (newFileUri != null) {
                        ...
                        val images = arrayListOf(
                            Image(uri = newFileUri!!, name = currentFileName!!, bucketId = 0, bucketName = config.subDirectory!!)
                        )
