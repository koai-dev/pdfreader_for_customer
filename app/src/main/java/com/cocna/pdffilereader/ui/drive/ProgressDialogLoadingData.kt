...
import com.cocna.pdffilereader.databinding.DialogLoadingDataBinding
 ...
 */
class ProgressDialogLoadingData(private val mContext: BaseActivity<*>) : Dialog(mContext, android.R.style.Theme_Material_Dialog) {
...
//        }
        val bind: DialogLoadingDataBinding = DialogLoadingDataBinding.inflate(LayoutInflater.from(mContext))
