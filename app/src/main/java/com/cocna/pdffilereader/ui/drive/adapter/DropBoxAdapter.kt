...
class DropBoxAdapter(
    ...
    private val lstData: ArrayList<FileMetadata>,
    ...
    fun updateData(mlstData: ArrayList<FileMetadata>) {
        this.lstData.clear()
    ...
    interface OnItemClickListener {
        fun onClickItem(documentFile: FileMetadata)
    }
